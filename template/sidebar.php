    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    <a href="../siswa/dashboard.php" class="nav_link active">
                        <i class="bx bx-grid-alt nav_icon"></i>
                        <span class="nav_name">Dashboard</span>
                    </a>
                    <a href="../siswa/daftar_materi.php" class="nav_link">
                        <i class="bx bx-clipboard nav_icon"></i>
                        <span class="nav_name">List Materi</span>
                    </a>
                    <a href="../siswa/kelas.php" class="nav_link">
                        <i class="bx bx-chalkboard nav_icon"></i>
                        <span class="nav_name">Class</span>
                    </a>
                    <a href="../siswa/pembayaran.php" class="nav_link">
                        <i class="bx bx-money nav_icon"></i>
                        <span class="nav_name">Pembayaran</span>
                    </a>
