...
$query_get_kelas_user = 'SELECT k.nama, k.kode_kelas, j.hari, j.jam, d.kelas_id FROM daftar_siswa d JOIN kelas k ON d.kelas_id = k.id JOIN jadwal_kelas j ON k.id = j.kelas_id WHERE d.siswa_id = 1 GROUP BY j.hari, k.nama, k.kode_kelas, j.jam, d.kelas_id';
