...
// get all pendaftar
$query_pendaftar = 'SELECT s.nama ,c.nama, s.no_hp, p.is_verified FROM siswas s join pembayaran p on s.id = p.siswa_id join cabang c on p.cabang_id = c.id ORDER BY s.created_at DESC';
...
<div class="container container-boxed main-content">
    ...
    <div class="container container-boxed mt-5">
      ...
      <div class="row p-3">
        ...
        <div class="col-md-4">
          <div class="card-statistic">
            <div class="card-statistic-number csn-danger">200</div>
            <div class="card-statistic-text">Pendaftar Ditolak</div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card-statistic">
            <div class="card-statistic-number csn-warning">200</div>
            <div class="card-statistic-text">Pendaftar Belum Diverifikasi</div>
          </div>
        </div>
        <div class="col-md-8">
          <div class="card">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                    <?php foreach ($pendaftar as $pendaftar) { ?>
                        ...
                        <td><?php echo $pendaftar['is_verified']; ?></td>
                        <td>
                            <a href="verifikasi.php?id=<?php echo $pendaftar['id']; ?>" class="btn btn-success">Verifikasi</a>
                            <a href="tolak.php?id=<?php echo $pendaftar['id']; ?>" class="btn btn-danger">Tolak</a>
                        </td>
                        </tr>
                    <?php } ?>
                </tbody>
